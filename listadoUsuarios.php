            ...
            <?php foreach($usuarios as $usuario):?>
                ...
                <div class="col mb-4">
                    ...
                    <div class="card h-100">
                        ...
                        <img src="<?php echo($usuario["foto"]) ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editar<?php echo($usuario["idUsuario"]) ?>">
                            Editar
                        </div>
                        </div>
